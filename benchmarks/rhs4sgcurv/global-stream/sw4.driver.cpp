...
extern "C" void host_code (double*, double*, double*, double*, double*, double*, double*, double*, double*, double*, double*, double*, double*, double*, double*, int, int, int);
...
int main(int argc, char** argv) {
	...
	double (*jac)[320][320] = (double (*)[320][320]) getRandom3DArray<double>(320, 320, 320);
	double (*met_0)[320][320] = (double (*)[320][320]) getRandom3DArray<double>(320, 320, 320);
	double (*met_1)[320][320] = (double (*)[320][320]) getRandom3DArray<double>(320, 320, 320);
	double (*met_2)[320][320] = (double (*)[320][320]) getRandom3DArray<double>(320, 320, 320);
	double (*met_3)[320][320] = (double (*)[320][320]) getRandom3DArray<double>(320, 320, 320);
	...
	double (*uacc_0)[320][320] = (double (*)[320][320]) getRandom3DArray<double>(320, 320, 320);
	...
	sw4_gold ((double*)uacc_gold_0, (double*)uacc_gold_1, (double*)uacc_gold_2, (double*)u_0, (double*)u_1, (double*)u_2, (double*)mu, (double*)la, (double*)met_0, (double*)met_1, (double*)met_2, (double*)met_3, (double*)jac, (double*)strx, (double*)stry, N);
	host_code ((double*)uacc_0, (double*)uacc_1, (double*)uacc_2, (double*)u_0, (double*)u_1, (double*)u_2, (double*)mu, (double*)la, (double*)met_0, (double*)met_1, (double*)met_2, (double*)met_3, (double*)jac, (double*)strx, (double*)stry, N, N, N);

...
extern "C" void host_code (double *h_out, double *h_in, double h2inv, double a, double b, int L, int M, int N);
...
int main(int argc, char** argv) {
  ...
  jacobi_gold((double*) out_gold, (double *)tmp, (double*) in, h2inv, a, b, N, N, N);

...
extern "C" void cheby_gold (double* out, double *Ac, double* Ap, double* RHS, double* Dinv, double h2inv, double c1, double c2, int N) {
	...
	cheby_step(temp2, temp1, Ac, RHS, Dinv, h2inv, c1, c2, N);
	cheby_step(temp3, temp2, temp1, RHS, Dinv, h2inv, c1, c2, N);
	cheby_step(temp1, temp3, temp2, RHS, Dinv, h2inv, c1, c2, N);
	cheby_step(temp2, temp1, temp3, RHS, Dinv, h2inv, c1, c2, N);
	cheby_step(out, temp2, temp1, RHS, Dinv, h2inv, c1, c2, N);
